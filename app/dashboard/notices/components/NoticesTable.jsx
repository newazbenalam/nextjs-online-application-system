...
export default function NoticesTable({ ticketData, classNamez, params, perPage = 8 }) {
                ...
                currentItems.map((ticket, index) => (
                  ...
                  >
                    ...
                    <td className="align-middle">
                      <button onClick={() => DeleteNotice(ticket?.id)} className="btn btn-link text-secondary mb-0">
                        <i
                          className="ni ni-fat-delete text-xs"
                          aria-hidden="true"
                        ></i>
                      </button>
                    </td>
