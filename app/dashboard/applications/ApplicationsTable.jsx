...
export default function ApplicationsTable({ ticketData, classNamez, params, perPage = 8 }) {
                    ...
                    <td>
                      <div className="d-flex px-2">
                        <div className="my-auto pl-0">
                          ...
                          >
                            {ticket?.paymentInfo?.totalAmount +' BDT '}
                          </h6>
                        </div>
                      </div>
                    </td>
